LU: 2024-10-11 15:46 UTC+7
TI: Decompiling, patching and recompiling Vsmart Camera (part 1/n)
...
<code>com.bq.camera3.a.f</code> class contains objects made for specific devices.
...
<ul>
    ...
    <li><code>move-result</code> assigns the target register with the last recent invoke's value. For example:
        ...
        Will assign the value of <code>TextUtils.isEmpty()</code> call to v1.
    </li>
...
Now open the app. Oh it's frozen!
